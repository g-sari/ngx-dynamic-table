...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    <ul class="list">
        <li class="title">
            <a href="index.html" data-type="index-link">NGX DYNAMIC MATERIAL TABLE</a>
        </li>
        <li class="divider"></li>
...
` : '' }
            ...
            ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                    ...
                    <li class="link">
                        <a href="modules/DynamicTableModule.html" data-type="entity-link">DynamicTableModule</a>
                            <li class="chapter inner">
                                <div class="simple menu-toggler" data-toggle="collapse"
                                    ${ isNormalMode ? 'data-target="#components-links-module-DynamicTableModule-4cdcd224fdeb0ae3debc13f33750cab3"' : 'data-target="#xs-components-links-module-DynamicTableModule-4cdcd224fdeb0ae3debc13f33750cab3"' }>
                                    <span class="icon ion-md-cog"></span>
                                    <span>Components</span>
                                    <span class="icon ion-ios-arrow-down"></span>
                                </div>
                                <ul class="links collapse"
                                    ${ isNormalMode ? 'id="components-links-module-DynamicTableModule-4cdcd224fdeb0ae3debc13f33750cab3"' : 'id="xs-components-links-module-DynamicTableModule-4cdcd224fdeb0ae3debc13f33750cab3"' }>
                                        <li class="link">
                            ...
                            <li class="chapter inner">
                                <div class="simple menu-toggler" data-toggle="collapse"
                                    ${ isNormalMode ? 'data-target="#directives-links-module-DynamicTableModule-4cdcd224fdeb0ae3debc13f33750cab3"' : 'data-target="#xs-directives-links-module-DynamicTableModule-4cdcd224fdeb0ae3debc13f33750cab3"' }>
                                    <span class="icon ion-md-code-working"></span>
                                    <span>Directives</span>
                                    <span class="icon ion-ios-arrow-down"></span>
                                </div>
                                <ul class="links collapse"
                                    ${ isNormalMode ? 'id="directives-links-module-DynamicTableModule-4cdcd224fdeb0ae3debc13f33750cab3"' : 'id="xs-directives-links-module-DynamicTableModule-4cdcd224fdeb0ae3debc13f33750cab3"' }>
                                        <li class="link">
                            ...
                            <li class="chapter inner">
                                <div class="simple menu-toggler" data-toggle="collapse"
                                    ${ isNormalMode ? 'data-target="#injectables-links-module-DynamicTableModule-4cdcd224fdeb0ae3debc13f33750cab3"' : 'data-target="#xs-injectables-links-module-DynamicTableModule-4cdcd224fdeb0ae3debc13f33750cab3"' }>
                                    <span class="icon ion-md-arrow-round-down"></span>
                                    <span>Injectables</span>
                                    <span class="icon ion-ios-arrow-down"></span>
                                </div>
                                <ul class="links collapse"
                                    ${ isNormalMode ? 'id="injectables-links-module-DynamicTableModule-4cdcd224fdeb0ae3debc13f33750cab3"' : 'id="xs-injectables-links-module-DynamicTableModule-4cdcd224fdeb0ae3debc13f33750cab3"' }>
                                        <li class="link">
        ...
        <li class="chapter">
            ...
            ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                    ...
                    <li class="link">
                        <a href="classes/AbstractWebLibraryComponent.html" data-type="entity-link">AbstractWebLibraryComponent</a>
                    </li>
                    <li class="link">
                    ...
                    <li class="link">
                        <a href="classes/DynamicTableExpressionBuilder.html" data-type="entity-link">DynamicTableExpressionBuilder</a>
                    </li>
                    <li class="link">
                        <a href="classes/DynamicTableUIUtils.html" data-type="entity-link">DynamicTableUIUtils</a>
                    </li>
                    <li class="link">
